      ...
      <div className='stripContainer'>
        ...
        <div style={styles} >
          <Marquee speed={200} style={styles0} >
            ...
            <div className='edition_text2'>26 EDITIONS</div>
          </Marquee>
        ...
        <div  >
          ...
          <div style={styles1}>
            <Marquee speed={200} style={styles11} direction='right'>
              ...
              <div ><img className='star star11' src={star}></img></div>
              <div className='edition_text1'>500+ COLLEGES </div>
              <div><img className='star star21' src={star}></img></div>
              <div className='football_text1' >100+ EVENTS </div>
              <div ><img className='star star31' src={star}></img></div>
