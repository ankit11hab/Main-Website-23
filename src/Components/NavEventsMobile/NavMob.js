        ...
        <div className='overall_nav'>
            <div className='main-nav'>
                ...
                <ul className="Navmoblist" style={{listStyle: 'none'}}>
                    <li><NavLink to="/Events" style={{textDecoration: 'none',color:'#1A1A1A'}}>PRONITES</NavLink><img src={click?dropimg:uparrow} alt="" style={{cursor:'pointer'}} onClick={handleClick}></img></li>
                ...
                {pathname==='/Events/cc'?
                <ul className="Navmoblist" style={{listStyle: 'none'}}>
                    <li><NavLink to="/Events/cc" style={{textDecoration: 'none',color:'#1A1A1A',}} >CREATORS CAMP</NavLink><img src={click?dropimg:uparrow} alt="" style={{cursor:'pointer'}} onClick={handleClick}></img></li>
